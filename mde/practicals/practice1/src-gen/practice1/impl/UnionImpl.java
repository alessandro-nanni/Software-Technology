 ...
 * </p>
 * <ul>
 *   <li>{@link practice1.impl.UnionImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link practice1.impl.UnionImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnionImpl extends QueryImpl implements Union {
	...
	protected EClass eStaticClass() {
		return Practice1Package.Literals.UNION;
	}
	...
	public NotificationChain basicSetLeft(Query newLeft, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Practice1Package.UNION__LEFT,
					oldLeft, newLeft);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLeft != left) {
			...
			if (left != null)
				msgs = ((InternalEObject) left).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Practice1Package.UNION__LEFT, null, msgs);
			if (newLeft != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Practice1Package.UNION__LEFT, newLeft, newLeft));
	}
	...
	public NotificationChain basicSetRight(Query newRight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Practice1Package.UNION__RIGHT, oldRight, newRight);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRight != right) {
			...
			if (right != null)
				msgs = ((InternalEObject) right).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Practice1Package.UNION__RIGHT, null, msgs);
			if (newRight != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Practice1Package.UNION__RIGHT, newRight, newRight));
	}
