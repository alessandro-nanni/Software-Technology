 ...
 * </p>
 * <ul>
 *   <li>{@link practice1.impl.ORImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link practice1.impl.ORImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ORImpl extends ConditionImpl implements OR {
	...
	protected EClass eStaticClass() {
		return Practice1Package.Literals.OR;
	}
		...
		if (left != null && left.eIsProxy()) {
			...
			if (left != oldLeft) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Practice1Package.OR__LEFT, oldLeft,
							left));
			}
		}
		return left;
	...
	public void setLeft(Condition newLeft) {
		...
		left = newLeft;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Practice1Package.OR__LEFT, oldLeft, left));
	}
	...
	public Condition getRight() {
		if (right != null && right.eIsProxy()) {
			...
			if (right != oldRight) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Practice1Package.OR__RIGHT, oldRight,
							right));
			}
		}
		return right;
	...
	public void setRight(Condition newRight) {
		...
		right = newRight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Practice1Package.OR__RIGHT, oldRight, right));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Practice1Package.OR__LEFT:
			if (resolve)
				return getLeft();
			return basicGetLeft();
		case Practice1Package.OR__RIGHT:
			if (resolve)
				return getRight();
