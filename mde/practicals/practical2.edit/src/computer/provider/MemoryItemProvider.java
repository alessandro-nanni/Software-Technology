...
public class MemoryItemProvider extends ComponentItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ComputerPackage.Literals.MEMORY__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addCapacityGBPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Memory_capacityGB_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Memory_capacityGB_feature", "_UI_Memory_type"),
				 ComputerPackage.Literals.MEMORY__CAPACITY_GB,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Memory_type") + " " + memory.getPowerConsumption();
	}
