...
public class ProcessorItemProvider extends ComponentItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Processor_model_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Processor_model_feature", "_UI_Processor_type"),
				 ComputerPackage.Literals.PROCESSOR__MODEL,
				 true,
				 false,
				 false,
	...
	protected void addSocketPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Processor_socket_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Processor_socket_feature", "_UI_Processor_type"),
				 ComputerPackage.Literals.PROCESSOR__SOCKET,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addCoresPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Processor_cores_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Processor_cores_feature", "_UI_Processor_type"),
				 ComputerPackage.Literals.PROCESSOR__CORES,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Processor_type") + " " + processor.getPowerConsumption();
	}
