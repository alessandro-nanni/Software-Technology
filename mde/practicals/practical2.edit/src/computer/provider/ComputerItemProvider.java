...
public class ComputerItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ComputerPackage.Literals.COMPUTER__GRAPHICS_CARD);
			...
			childrenFeatures.add(ComputerPackage.Literals.COMPUTER__CD_DRIVE);
			childrenFeatures.add(ComputerPackage.Literals.COMPUTER__PERIPHERALS);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ComputerPackage.Literals.COMPUTER__GRAPHICS_CARD,
		...
		newChildDescriptors.add
			(createChildParameter
				(ComputerPackage.Literals.COMPUTER__CD_DRIVE,
				 ComputerFactory.eINSTANCE.createCDDrive()));

		newChildDescriptors.add
			(createChildParameter
				(ComputerPackage.Literals.COMPUTER__PERIPHERALS,
				 ComputerFactory.eINSTANCE.createMonitor()));
