...
/**
 * This is the item provider adapter for a {@link practice1.Comparison} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComparisonItemProvider extends ConditionItemProvider {
	...
	protected void addLeftPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Comparison_left_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Comparison_left_feature",
								"_UI_Comparison_type"),
						Practice1Package.Literals.COMPARISON__LEFT, true, false, true, null, null, null));
	}
	...
	protected void addRightPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Comparison_right_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Comparison_right_feature",
								"_UI_Comparison_type"),
						Practice1Package.Literals.COMPARISON__RIGHT, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Comparison_operator_feature",
								"_UI_Comparison_type"),
						Practice1Package.Literals.COMPARISON__OPERATOR, true, false, false,
	...
	public String getText(Object object) {
		ComparisonOp labelValue = ((Comparison) object).getOperator();
