 ...
 * <!-- end-user-doc -->
 * @see computer.ComputerPackage#getMemoryType()
 * @model
 * @generated
 */
public enum MemoryType implements Enumerator {
	 ...
	 * @ordered
	 */
	public static final int DDR4_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int DDR5_VALUE = 1;
	...
	public static MemoryType get(int value) {
		switch (value) {
			case DDR4_VALUE: return DDR4;
			case DDR5_VALUE: return DDR5;
		}
		return null;
	}
