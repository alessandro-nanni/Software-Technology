...
public class ComputerAdapterFactory extends AdapterFactoryImpl {
	...
	protected ComputerSwitch<Adapter> modelSwitch =
		new ComputerSwitch<Adapter>() {
			...
			@Override
			public Adapter caseCDDrive(CDDrive object) {
				return createCDDriveAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link computer.Component <em>Component</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link computer.CDDrive <em>CD Drive</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCDDriveAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link computer.Peripheral <em>Peripheral</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link computer.Monitor <em>Monitor</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
