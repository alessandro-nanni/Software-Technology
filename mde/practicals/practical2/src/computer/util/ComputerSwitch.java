...
public class ComputerSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ComputerPackage.MOTHERBOARD: {
				...
				if (result == null) result = caseComponent(motherboard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ComputerPackage.GRAPHICS_CARD: {
				...
				if (result == null) result = caseComponent(graphicsCard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ComputerPackage.HARD_DISK: {
				...
				if (result == null) result = caseComponent(hardDisk);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComputerPackage.CD_DRIVE: {
				CDDrive cdDrive = (CDDrive)theEObject;
				T result = caseCDDrive(cdDrive);
				if (result == null) result = caseComponent(cdDrive);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComputerPackage.PERIPHERAL: {
				...
				if (result == null) result = caseComponent(peripheral);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComputerPackage.MONITOR: {
				...
				if (result == null) result = casePeripheral(monitor);
				if (result == null) result = caseComponent(monitor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComputerPackage.KEYBOARD: {
				...
				if (result == null) result = casePeripheral(keyboard);
				if (result == null) result = caseComponent(keyboard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComputerPackage.MOUSE: {
				...
				if (result == null) result = casePeripheral(mouse);
				if (result == null) result = caseComponent(mouse);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComputerPackage.PRINTER: {
				...
				if (result == null) result = casePeripheral(printer);
				if (result == null) result = caseComponent(printer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>CD Drive</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>CD Drive</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCDDrive(CDDrive object) {
		return null;
	}
