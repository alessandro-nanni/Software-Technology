...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Port</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.xtext.example.computer.computerDsl.ComputerDslPackage#getPort()
 * @model
 * @generated
 */
public enum Port implements Enumerator
{
  /**
  ...
  /**
   * An array of all the '<em><b>Port</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private static final Port[] VALUES_ARRAY =
    new Port[]
    {
      USB,
      PS2,
  ...
  /**
   * A public read-only list of all the '<em><b>Port</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final List<Port> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Port</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public static Port get(String literal)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      Port result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Port</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param name the name.
   * @return the matching enumerator or <code>null</code>.
   * @generated
   */
  public static Port getByName(String name)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      Port result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Port</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public static Port get(int value)
  {
    switch (value)
    {
   ...
   * @generated
   */
  private Port(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
