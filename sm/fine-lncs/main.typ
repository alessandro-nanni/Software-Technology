...
To efficiently collect this data, McGuire utilized 5-point Likert-scale surveys covering 79 distinct factors across categories like project management, teamwork, change management, and quality focus @mcguire1996. While McGuire noted that Likert scales are inherently limited to capturing subjective perceptions rather than objective facts, they remain a highly effective means of quickly gathering data and revealing overarching trends in developer thinking @mcguire1996. I apply this same principle more narrowly in my primary study, using linear scales on select questions to gauge specific process related behaviors, even if their coding environment fundamentally lacks formal structure.
...
When asked which software development process they use when working in a group (Q15), more than half (55.8%) of the respondents that work in groups reported not having a structured development process. No one claimed to use Scrum, and only two respondents use extreme programming.

With regard to coding conventions (Q21), 81.4% of the respondents claimed to adopt different namespaces across projects, and 48.5% also use the more advanced _Smithed_ conventions#footnote[Smithed is a community that defined a set of naming and structural conventions, aswell as developing a "standard library" ecosystem for datapack development (https://docs.smithed.dev/index.html).]. Six users stated that they do not know what coding conventions are or that they do not use them. Two responses also mentioned the use of IMP-doc, a comment convention similar to Javadoc, but applied to datapack functions.
...
=== Internal Validity
- Insufficient knowledge for young developers. 13.4% of the respondents are either 18 years or younger. It is very unlikely for people at that age to be familiar with software development or project management concepts, which are usually learnt in higher education or through work experience.
