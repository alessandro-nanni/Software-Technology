...
The remainder of this paper is structured as follows. Section 2 provides the theoretical background of the Minecraft DSL, detailing its syntactical limitations and structural constraints. Section 3 reviews related literature in DSL usability, video game development, and end user software engineering. Section 4 presents the survey methodology and descriptive results. In Section 5, we discuss these findings by contrasting them against established academic paradigms and performing a quantitative analysis of my research hypotheses. Finally, Section 6 concludes the paper.
...
To complement this rigid corporate perspective, I also examined how modern surveys measure productivity in flexible, non-contractual /*dont like this*/ environments. Canedo et al. conducted an empirical study combining a systematic literature review with an online survey of software practitioners to evaluate 37 different factors that influence team productivity @canedo2019. Similarly to Hermans et al., they heavily relied on closed questions using 5-point Likert scales to capture the opinions of the developers.
...
Following the structured methodologies seen in related DSL and software engineering studies, this section is dedicated to presenting the quantitative and qualitative data obtained from the respondents. Therefore, I will not be making cross-domain /*dont like this*/ evaluations here. Instead, the comparative analysis where I contextualize these findings against the established literature on general purpose languages, independent game development, and formal DSL practices will be entirely delegated to the subsequent @discussion_ch @ALBUQUERQUE2015 @cho2023.
...
While the preceding subsections contrast datapack development against established software engineering and end user programming literature, we must evaluate whether these observed trends hold true under rigorous statistical testing. Therefore, this section presents an analysis of seven research hypotheses concerning developer demographics, coding abstractions, team collaboration, and refactoring efforts.
